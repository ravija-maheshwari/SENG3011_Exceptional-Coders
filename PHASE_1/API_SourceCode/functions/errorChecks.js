...
exports.checkMissingQueryParams = function(req) {
...
exports.checkDateFormat = function checkDateFormat(req) {
...
exports.isStartBeforeEnd = function isStartBeforeEnd(req) {
