...
for post in posts:
    ...
    if country:
        ...
        if domain == "flutrackers":
            ...
            title = soup_post.find('div', class_='b-media__body') # b-post__contentd
            ...
            url = soup_post.find('div', class_='js-post__content-text restore h-wordwrap')
            # print(url)
            url = url.a['href']
            text = soup_post.find('div', class_='js-post__content-text restore h-wordwrap')
            text = getText(text)
